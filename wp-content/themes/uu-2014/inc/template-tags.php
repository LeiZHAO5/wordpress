 ...
 * Shims included for recent WP features
 *
 * @package UU2014
 */
...
/**
 * Shim for `the_posts_navigation()` introduced in WP 4.1.
...
function the_posts_navigation() {
    ...
    <nav class="navigation paging-navigation" role="navigation">
        <h2 class="screen-reader-text"><?php _e( 'Posts navigation', 'uu2014' ); ?></h2>
        <div class="nav-links">

            <?php if ( get_next_posts_link() ) : ?>
            <div class="nav-previous"><?php next_posts_link( __( 'Older posts', 'uu2014' ) ); ?></div>
            <?php endif; ?>

            <?php if ( get_previous_posts_link() ) : ?>
            <div class="nav-next"><?php previous_posts_link( __( 'Newer posts', 'uu2014' ) ); ?></div>
            <?php endif; ?>
...
/**
 * Shim for `the_post_navigation()` introduced in WP 4.1.
...
function the_post_navigation() {
    ...
    <nav class="navigation post-navigation" role="navigation">
        <h2 class="screen-reader-text"><?php _e( 'Post navigation', 'uu2014' ); ?></h2>
        <div class="nav-links">
            <?php
...
/**
 * Shim for `the_archive_title()` introduced in WP 4.1.
 *
...
/**
 * Shim for `the_archive_description()` introduced in WP 4.1.
 *
