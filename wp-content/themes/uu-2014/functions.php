...
function uu2014_scripts() {
	...
	wp_enqueue_style('uu2014-style', get_stylesheet_uri(), array('uu2014-google-fonts-style', 'dashicons'), '20150115');

	wp_enqueue_script( 'uu2014-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20150111', true );

	wp_enqueue_script('uu2014-script', get_template_directory_uri().'/js/functions.js', array('jquery'), '20150111', true);
	...
	if (get_theme_mod('uu2014_display_floating_widgets', 1) && is_active_sidebar('sharebar') && (is_single() || is_page())) {
		...
		wp_localize_script('uu2014-sharebar-script', 'uu2014_floating_widgets', $uu2014_floating_widgets_param);
	}
